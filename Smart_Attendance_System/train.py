...
class Train:
    ...
    def __init__(self,root):
        ...
        # backgorund image 
        bg1=Image.open(r"D:\Smart_Attendance_System\Images_GUI\t_bg1.jpg")
        ...
        #title section
        title_lb1 = Label(bg_img,text="Welcome to Data Training Pannel",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        title_lb1.place(x=0,y=0,width=1366,height=45)

        # Create buttons below the section 
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn=Image.open(r"D:\Smart_Attendance_System\Images_GUI\t_btn1.jpg")
    ...
    def train_classifier(self):
        ...
        ids=np.array(ids)  # converting ids into numpy
        
        #=================Train Classifier=============
        clf= cv2.face.LBPHFaceRecognizer_create()    #local Binary Pattern Histogram from open cv 
        clf.train(face,ids)
        clf.write("clf.xml")
